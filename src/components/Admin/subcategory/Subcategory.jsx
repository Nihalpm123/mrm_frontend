...
const Subcategory = () => {
  ...
  useEffect(() => {
    axios.get(`${server}/get-subcategory/${id}`).then((res) => {
  ...
  const handleDelete = (id) => {
    axios
      .delete(`${server}/delete-category/${id}`)
      .then((res) =>
        setCategory((data) => data.filter((item) => item._id !== id))
      );
  };
  const handleView = (id) => {
  ...
  const handleOpenEdit = (e) => {
    ...
    axios
      .patch(`${server}/edit-category/${categoryId}`, updateCategory, config)
      .then((res) => {
            ...
            <tbody>
              {category.map((item, index) => (
                <tr key={index}>
                  ...
                  <td>
                    <img src={item.categoryImage} className="categoryImage" />
                  </td>
                  <td className="action-box">
                    <button
                      onClick={() => handleEdit(item)}
                      className="actionedit-btn"
                    >
                      Edit
                    </button>
                    <button
